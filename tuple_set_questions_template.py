...
print(f'student in both math and cs classes:{both_cs_math}')

only_math = math_students.difference(cs_students)
print(f'students only in math classes:{only_math}')

either_math_cs = math_students.symmetric_difference(cs_students)
print(f'Sdent in either math and cs classes:{either_math_cs}')
...
not_baannes_ids = set(user_ids) - banned_ids
print(f'IDs not banned:{not_baannes_ids}')
